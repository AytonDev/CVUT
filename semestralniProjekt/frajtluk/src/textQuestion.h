...
#ifndef SEMESTRALNIPROJEKT_TEXTQUESTION_H
#define SEMESTRALNIPROJEKT_TEXTQUESTION_H
 ...
 * 
 */
class CTextQuestion : public CBaseQuestion {
    public:
    /**
     * @brief Construct a new CTextQuestion object
     * 
     * @param questionText 
     * @param rightAnswer 
     * @param ID 
     ...
     */
    CTextQuestion(string questionText, string rightAnswer, int ID, int page, int quizID, int points,bool dependOnLastAnswer = false, int lastQuestionID = 0, 
     ...
     * @param lastQuestionAnswer 
     */
    CTextQuestion(string questionText, string rightAnswer, int page, int quizID, int points, bool dependOnLastAnswer = false, int lastQuestionID = 0, 
    int lastQuestionAnswer = 0);
    /**
    ...
    /**
     * @brief Destroy the CTextQuestion object
     * 
     */
    ~CTextQuestion();
    /**
     ...
     */
    static CTextQuestion PrintQuestionBuilder(ostream &os, istream &is, CQuizManager &quiz);
    /**
...
#endif //SEMESTRALNIPROJEKT_TEXTQUESTION_H
